...
short_interval = '5m'
pairs = [['ADA', 'ADAM18'], ['BCC', 'BCHM18'], ['LTC', 'LTCM18'], ['XRP', 'XRPM18']]
long_exchanges = ['binance']
x = 400 #moving average window size
y = 400 #std dev window size
...
#            bittrex_prices = pg.update_bittrex(bittrex_prices, longcoins, bittrex_interval)
            ...
            for symbols in pairs:
                for exchange in long_exchanges:        
                    ...
                    duplicates = prices[prices.index.duplicated(keep=False)]
                    if len(duplicates) > 0:
                        print(duplicates)
